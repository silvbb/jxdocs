...
import {
  genFeiShuSideBar,
  genNotionSideBar,
  genFeiShuwikiSideBar,
} from "../theme/utils/route.ts";

//测试
// if (typeof window !== 'undefined') {
//   // 这段代码只会在浏览器环境中执行
//   window.addEventListener('DOMContentLoaded', () => {
//     console.log("浏览器端：侧边栏已加载")
//   })
// }
// 添加更明显的日志输出
console.log("\n\n========== 正在生成侧边栏配置 ==========\n\n");
...
export const sidebar: DefaultTheme.Config["sidebar"] = {
  ...
  //'/feishu/': getItems('/feishu/docs/')|| [],
  "/feishu/": genFeiShuSideBar("/feishu/docs/") || [],
  "/feishu-wiki/": genFeiShuwikiSideBar("/feishu-wiki/docs/") || [],
  // '/notion/': getItems("/notion/docs/")
  "/notion/": genNotionSideBar("/notion/docs/") || [],
};
console.log("\n\n========== 侧边栏生成完成 ==========\n\n");
/**
